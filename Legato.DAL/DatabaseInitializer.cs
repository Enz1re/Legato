...
namespace Legato.DAL
{
    class DatabaseInitializer : CreateDatabaseIfNotExists<GuitarContext>
    {
        protected override void Seed(GuitarContext context)
        {
            ...
            context.ElectroGuitars.Add(new ElectroGuitarModel { Vendor = "Rogue", Model = "RR100 Rocketeer", HasTremoloBar = true, Soundbox = "Humbucker", StringCaliber = 9, StringNumber = 6, Mensura = 647, Price = 2883, ImgPath = "Content/img/Electric/rogue_rr100_rocketeer.png" });
            context.ElectroGuitars.Add(new ElectroGuitarModel { Vendor = "Friedman", Model = "Vintage-T HH Mapple Fingerboard", HasTremoloBar = false, Soundbox = "Humbucker", StringNumber = 6, StringCaliber = 9, Mensura = 646, Price = 77850, ImgPath = "Content/img/Electric/friedman_vintage_t_hh_mapple_fingerboard.png" });
            context.ElectroGuitars.Add(new ElectroGuitarModel { Vendor = "B.C. Rich", Model = "Warbeast", HasTremoloBar = true, Soundbox = "Humbucker", StringCaliber = 10, StringNumber = 6, Mensura = 647, Price = 12109, ImgPath = "Content/img/Electric/b_c_rich_warbeast.png" });
            context.ElectroGuitars.Add(new ElectroGuitarModel { Vendor = "The Loar", Model = "LH-302T", HasTremoloBar = false, Soundbox = "Single", StringCaliber = 9, StringNumber = 6, Mensura = 646, Price = 15780, ImgPath = "Content/img/Electric/the_loar_lh_302t.png" });
